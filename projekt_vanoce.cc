...
/******************************************************************************/
/**  Situace:   Zvyseny provoz pred Vanocemi s navysenym poctem aut.         **/
/******************************************************************************/
...
#define POCET_AUT_USTI    3
#define POCET_AUT_LIBEREC 3
#define POCET_AUT_HRADEC  3
#define POCET_AUT_BRNO   11
#define POCET_AUT_PLZEN   4
...
#define PRICHODY_USTI    33.52
#define PRICHODY_LIBEREC 36.34
#define PRICHODY_HRADEC  33.30
#define PRICHODY_BRNO   134.77
#define PRICHODY_PLZEN   59.51
...
int main()
{
  ...
  /* Nastaveni vystupu */
  SetOutput("output_projekt_vanoce.dat");
