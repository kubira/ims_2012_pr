...
/******************************************************************************/
/**  Situace:   Zvyseny provoz pred Vanocemi bez navyseni poctu aut.         **/
/******************************************************************************/
...
Histogram dobaCesty("Celkova doba cesty zasilky v minutach", 120, 15, 260);
...
int main()
{
  ...
  /* Nastaveni vystupu */
  SetOutput("output_projekt_vanoce_bez_navyseni.dat");
